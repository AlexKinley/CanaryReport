...
\usepackage{mdframed}
\onehalfspacing
\definecolor{linkblue}{rgb}{0.00, 0.00, 0.93} 
...
\begin{center}
    ...
    \vspace {8mm} % Add vertical space between sections
    Project Advisor: \\ % Edit if only one advisor
    \vspace{2mm} % Add vertical space between sections
    Professor Joshua Cuneo \\ % Input name of first advisor
    \vspace {5mm} % Add vertical space between sections
    Date: March 2022 \\ % Input date of project submission
    }
    \vspace{0mm} % Add vertical space between sections
    \begin{figure}[H]
    \centering
    \includegraphics[width=0.35\textwidth]{Images/logo.png} % Set the image width relative to the with of the text on the page and input the name of the image that is being placed.
    \end{figure}
...
shutting down servers or even whole datacenters \parencite{tseitlin2013antifragile}.
...
%// Listing 2.6.1.1
\begin{longcode}
\begin{minted}[breaklines, breakanywhere, breaksymbolleft={}, linenos]{js}
...
%// Listing TB.1
\begin{longcode}
\begin{minted}[breaklines, breakanywhere, breaksymbolleft={}, linenos]{json}
{
    "id": "my-test-world",
    "size": [
        16,
...
%// Figure 4.3.4.1
%\begin{lstlisting}[caption=Sample Log]

\begin{listing}[H]
\begin{minted}[breaklines, breakanywhere, breaksymbolleft={}, linenos]{text}
Testing complete.
1 test failed.
...
%// Listing CD.1
\begin{listing}[H]
\begin{minted}[breaklines, breakanywhere, breaksymbolleft={}, linenos]{java}
@InWorldTest
...
\begin{figure}[H] 
    ...
    %{The error message for test 3\footnote{Thanks to github user CommandCracker8 for contributing this functionality}} 
    \label{fig:5_1_1_4}  
\end{figure}

\footnotetext{Thanks to GitHub user CommandCracker8 for contributing the hastebin feature, where the stacktrace is uploaded for the user to view}
...
\begin{listing}[H]
\begin{minted}[breaklines, breakanywhere, breaksymbolleft={}, linenos]{kotlin}
// build.gradle.kts
